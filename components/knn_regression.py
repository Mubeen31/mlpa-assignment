...
def knn_regression_chart_value(n_intervals, select_neighbors):
    if select_neighbors is None:
        raise PreventUpdate
    ...
    if time_name >= '00:00:00' and time_name <= '11:59:59':
        ...
        return_array = list(knn.predict(forcasted_data))
    ...
    return {
        ...
        'layout': go.Layout(
            ...
            title = {
                'text': 'K Nearest Neighbors Regression Model',
                'y': 0.88,
                'x': 0.28,
                'xanchor': 'center',
                'yanchor': 'top'},
